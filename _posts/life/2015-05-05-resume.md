...
+ 业务感觉 : 通过做需求,将业务提取出来,通过思考,根据以往的经历,提取出业务,并能根据所学创造和提出产品idea
+ 落地能力 : 事情分解能力和资源整合能力,落地能力
+ 算法能力 : 了解业界比较前言的算法,手动或者通过其他途径了解算法在业务中应用并能使用
+ 架构能力 : 算法和工程能力整合,并且根据业务画出整体流程图,并且能从长远的角度,做出架构;
<br>
<h3>
    <i class="fa fa-bookmark" aria-hidden="true"></i>
    <span>工作经验</span>
...
<ul class="nolist">
    ...
    <li>
            ...
            <span>我的职责:
		   <br>&nbsp;&nbsp;&nbsp;&nbsp;完成2019年全年的反馈OKR & 2020 成交率指标 & 无P4级以上故障;
		   <br>&nbsp;&nbsp;&nbsp;&nbsp;工程方向 : 策略稳定性架构设计,包含 搜索系统架构设计/渲染组件/司机索引构建/精品楼层/特征系统/在线机器学习模型系统/AB Test系统/pRec算法log日志系统/搜索策略稳定性;
		   <br>&nbsp;&nbsp;&nbsp;&nbsp;业务方向 : 反馈率项目 & 短途项目 & 一口价项目等重大项目落地
		   <br>&nbsp;&nbsp;&nbsp;&nbsp;策略方向 : 相似价格推荐(全国价格能力)/质量分/货找车设计/流量控制/流量突破/发货助手(发货推荐/成交预计时间/预估首通电话时间)/庖丁组件(NLP 信息抽取)/飞单检测/基于FM模型的搜索策略/详情页推荐等推荐场景/货主关联挖掘/其他算法场景;
	    </span>
        </li>
    </ul>
</ul>

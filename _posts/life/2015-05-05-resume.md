...
+ 业务感觉 : 通过做需求,将业务提取出来,通过思考,根据以往的经历,提取出业务,并能根据所学创造和提出一些产品idea,并能落地
+ 落地能力 : 事情分解能力和能力整合,将很多难做的事情落地
...
<ul class="nolist">
    ...
    <li>
		   ...
		   <br>&nbsp;&nbsp;&nbsp;&nbsp;策略方向 : 相似价格推荐(全国价格能力)/质量分/货找车设计/流量控制/流量突破/发货助手(发货推荐/成交预计时间/预估首通电话时间)/庖丁组件(NLP 信息抽取)/飞单检测/基于FM模型的搜索策略/详情页推荐等推荐场景;
	    </span>
        </li>
    </ul>
</ul>

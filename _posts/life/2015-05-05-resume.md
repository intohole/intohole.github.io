...
<ul class="nolist">
    ...
    <li>
		   ...
		   <br>完成策略稳定性架构设计,包含 搜索系统架构设计/渲染组件/精品楼层/特征系统/在线机器学习模型系统/AB Test系统/pRec算法log日志系统/搜索策略工程化;
		   <br>策略方向 : 流量控制/流量突破/相似价格推荐(全国价格能力)/发货助手(发货推荐/成交预计时间/预估首通电话时间)/庖丁组件(NLP 信息抽取)/飞单检测/基于FM模型的搜索策略/;
	    </span>
        </li>
    </ul>
</ul>
